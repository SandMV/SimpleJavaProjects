 ...
 *      например ru.compscicenter.java2014.implementor.InputInterface.
 ...
 *
 *   Внимание: конструктор Implementor'а не должен кидать исключения,
 *   иначе можно наткнуться на неприятные спецэффекты проверяющей системы.
*/
public interface Implementor {
     ...
     *
     * Например, требуется реализовать интерфейс `ru.compscicenter.AnInterface`.
     * Тогда в папке ожидается файл ru/compscicenter/AnInterface.class.
     * Implementor генерирует реализацию этого интерфейса, кладет её в
     * `workingDirectory`/ru/compscicenter/AnInterfaceImpl.java
     * и возвращает полное имя сгенерированного класса ru.compscicenter.AnInterfaceImpl.
     *
